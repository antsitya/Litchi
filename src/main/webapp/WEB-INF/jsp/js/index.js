...
//			alert("input:"+$(this).siblings(".admin-header-lock-input").val()+"pw"+pw);
			if($(this).siblings(".admin-header-lock-input").val() == pw){
...
//退出
function exit(){
	layer.confirm('您真的确定要退出吗？', {
		btn: ['确定','取消'] //按钮
	}, function(){
		layer.msg('Bye!', {icon: 1});	
		var userAgent = navigator.userAgent;
		if (userAgent.indexOf("Firefox") != -1 || userAgent.indexOf("Chrome") !=-1) {
		  window.location.href="about:blank";window.open('','_self').close();
