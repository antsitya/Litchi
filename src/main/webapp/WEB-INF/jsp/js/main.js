layui.config({
	...
	//用户数
	$.get("/Litchi/json/usersList.json",
		function(data){
	...
	if(window.sessionStorage.getItem("systemParameter")){
		...
		$.ajax({
			url : "/Litchi/json/systemParameter.json",
			type : "get",
			dataType : "json",
